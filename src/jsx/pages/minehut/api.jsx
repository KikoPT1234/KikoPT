class API extends React.Component {
    render() {
        return (<main>
            <h2>Welcome to the Minehut API Documentation. The Minehut API is what connects Minehut's front-end and back-end together, making it possible for a website or application to do things like start up a server, send commands, and change a file through HTTP requests. <br/><em>Special thanks to DeltaRays#0054. Documentation inspired by Vrganj and, you guessed it, Delta.<br/><span style={{"opacity": ".2", "font-size": ".5rem"}}>Seriously, Delta is a god. What he isn't is helpful, though.</span></em></h2>
