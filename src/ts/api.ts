            ...
            `<div class="doc" id="${i}">
                ...
                <div class="main">
                    ${(function() {
                        ...
                        if (doc.response) main += `<div class="response info"><p>Response Body Example<p>${response.startsWith("{") ? `<pre class="atom-one-dark"><code class="atom-one-dark json">${response}</code></pre>` : response}</div>`
